...
for section 4 of the report:
    ...
    figures/attention_rollout.png
    figures/cls_feature_importance.png
    figures/attention_per_head.png
    figures/defaulter_vs_nondefaulter_attention.png
    figures/feature_importance_comparison.png

Plus results/interpret.json with the raw importance rankings.
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        ...
        default=Path("results/rf_feature_importance.csv"),
    ...
    p.add_argument(
        ...
        default=Path("results/interpret.json"),
